...
public class Game extends JPanel {
    ...
    public void paint(Graphics g, Object Knight) {
        ...
        //defender.draw_character(g2d);
    
        
        //Speed fastKnight = new FastSpeedDecorator(new Knight());
     	//int speed = fastKnight.get_velocity();
     	//fastKnight.set_velocity(speed);
     	//fastKnight.draw_character(g2d);

        
        //Runner runner = new Runner();
        //runner.draw_character(g2d);  
